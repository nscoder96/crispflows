      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {pijnpunten.map((p) => (
                <div
                  key={p.title}
                  className="flex gap-4 items-start p-5 rounded-xl transition-colors duration-200"
                  style={{
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold text-base mb-1 text-white">{p.title}</h4>
          ...
          <div className="hidden lg:block relative">
            ...
            >
              <div className="text-3xl font-black leading-none text-black">3×</div>
              <div className="text-xs font-bold text-black/70 mt-1">meer aanvragen gemiddeld</div>
            </div>
          </div>
        </div>
      </div>
