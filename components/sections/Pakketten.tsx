...
export default function Pakketten() {
  return (
    <section className="py-28" style={{ background: "var(--dark-card)" }} id="pakket">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {pakketten.map((p) => (
            <div
              ...
              style={{
                background: p.featured ? "var(--dark)" : "var(--dark)",
                border: p.featured
            ...
            >
              {p.featured && (
                <div
                  className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-xs font-bold text-black tracking-wide"
              ...
              <a
                href="#contact"
                className="block text-center py-3.5 rounded-xl font-bold text-sm transition-all duration-200 hover:-translate-y-0.5 no-underline"
                style={
                  p.featured
